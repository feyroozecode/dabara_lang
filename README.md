...
| Hausa | Français | Usage | Misali |
|-------|----------|--------|---------|
| `fara` | commencer | Début de programme | `fara` |
| `ƙare` | finir | Fin de programme | `ƙare` |
| `rubuta` | écrire/imprimer | Afficher du texte | `rubuta "Sannu"` |
| `naɗa` | créer/définir | Déclarer une variable | `naɗa sunan = "Ahmad"` |
| `gaskiya` | vrai | Valeur booléenne vraie | `naɗa sahihi = gaskiya` |
| `karya` | faux | Valeur booléenne fausse | `naɗa karami = karya` |
| `ƙara` | ajouter | Addition | `lambar1 ƙara lambar2` |
| `rage` | retirer | Soustraction | `lambar1 rage lambar2` |
